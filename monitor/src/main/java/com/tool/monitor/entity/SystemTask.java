...
public class SystemTask {
    ...
    private String systemTaskLevel;
    private String systemTaskStatus;
    ...
    public void setSystemTaskId(String systemTaskId) {
    ...
    public String getSystemTaskLevel() {
        return systemTaskLevel;
    }

    public void setSystemTaskLevel(String systemTaskLevel) {
        this.systemTaskLevel = systemTaskLevel;
    }

    public String getSystemTaskStatus() {
        return systemTaskStatus;
    }

    public void setSystemTaskStatus(String systemTaskStatus) {
        this.systemTaskStatus = systemTaskStatus;
    }
    ...
    public String getEmergentNo() {
        return emergentNo;
    }

    public void setEmergentNo(String emergentNo) {
        this.emergentNo = emergentNo;
    }
    ...
    public String toString() {
        return MoreObjects.toStringHelper(this.getClass())
                .add("systemTaskId", systemTaskId)
                .add("systemTaskName", systemTaskName)
                .add("systemTaskNo", systemTaskNo)
                .add("systemTaskDesc", systemTaskDesc)
                .add("systemTaskLevel", systemTaskLevel)
                .add("systemTaskStatus", systemTaskStatus)
                .add("systemTaskOwner", systemTaskOwner)
                .add("planStartTime", planStartTime)
                .add("planFinishTime", planFinishTime)
                .add("systemCode", systemCode)
                .add("scheduleId", scheduleId)
                .add("scheduleName", scheduleName)
                .add("scheduleNo", scheduleNo)
                .add("emergentId", emergentId)
                .add("emergentName", emergentName)
                .add("emergentNo", emergentNo)
                .add("emergentType", emergentType)
                .add("reqCode", reqCode)
                .add("reqName", reqName)
                .add("reqDesc", reqDesc)
                .toString();
